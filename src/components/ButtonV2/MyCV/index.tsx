...
const MyCV = () => {
  return (
    <div className="flex w-200 mt-2 mb-20 drop-shadow-xl bg-white rounded	">
      <div className="col_left w-[350px] bg-indigo-600 flex flex-col items-center	drop-shadow-xl rounded">
